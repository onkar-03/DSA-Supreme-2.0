...
int expSearch(int arr[], int size, int element)
{
    ...
    // returning min of i and size - 1 becoz if the i exceeds the index bounds toh voh array toh exist hee nhi krega after size-1 index toh aise case mei to find the last index we find the min of i and the last index which will be the last index of the array
